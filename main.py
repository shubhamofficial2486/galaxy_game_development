...
class MainWidget(RelativeLayout):
    ...
    H_NB_LINES = 10
    H_LINES_SPACING = .3  # percentage in screen width
    horizontal_lines = []
    ...
    def __init__(self, **kwargs):
        ...
        #print("ON SIZE : H: " + str(self.width) + "H : " + str(self.height))
        self.init_audio()
        self.init_vertical_lines()
        self.init_horizontal_lines()
        self.init_tiles()
        self.init_ship()
        self.pre_fill_tiles_coordintes()
    ...
    def init_horizontal_lines(self):
        with self.canvas:
            Color(.5,.5,.5)
            #self.lines = Line(points=[99,0,100,100])
            for i in range (-1, self.H_NB_LINES):
    ...
    def pre_fill_tiles_coordintes(self):
        # 5 tiles in a straight line
        for i in range(0,5):
    ...
    def generate_tiles_coordinates(self):
        ...
        for i in range (len(self.tiles_coordinates),self.NB_TILES):
           ...
           # print(start_index,end_index,last_x)
            if r==1  :
                last_x +=1
                self.tiles_coordinates.append((last_x,last_y))
                last_y +=1
    ...
    def update_vertical_lines(self):
        ...
        #self.lines.points=[self.width/2,0,self.width/2,100]
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_game_has_started:
            ...
            speed_y = self.height * self.SPEED/100
            ...
            while self.current_offset_y >= spacing_y:
                ...
                self.current_loop+=1
                self.generate_tiles_coordinates()
                Clock.schedule_interval(self.increase_speed,20)
                self.score+=1
